...
abstract class Action {
   ...
   /**
    ...
    protected function ajaxReturn($data,$info='',$status=1,$type='') {
        ...
        $result['statusCode']  =  $status;	// jui
        $result['navTabId']  =  $_REQUEST['navTabId'];	// jui
        $result['rel']  =  $_REQUEST['rel'];	// jui
        $result['callbackType']  =  $_REQUEST['callbackType'];	// jui
        $result['forwardUrl']  =  $_REQUEST['forwardUrl'];	// jui
        $result['confirmMsg']  =  $_REQUEST['confirmMsg'];	// jui
        $result['message'] =  $info; // jui
        $result['info'] =  $info;
        $result['data'] = $data;;
