...
class MassEmailSettingModel extends Model {
  public function sendEmail($type, $sendEmail, $id){
    ...
    if(strstr($type, 'company')){
      ...
      $search = array('{shop_name}', '{shop_ordernum}', '{shop_result}', '{shop_addtime}', '{shop_address}', '{shop_linkman}', '{shop_mobilephone}', '{shop_member_name}', '{shop_member_nickname}', '{shop_send_time}');
    }
